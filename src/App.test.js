      ...
      items: [
        {
          ...
          sites: [{ logoSmall2x: 'path/to/logo1.png', title: 'Automation Site 1' }],
        ...
        },
        {
          ...
          sites: [{ logoSmall2x: 'path/to/logo2.png', title: 'Automation Site 2' }],
...
describe('App Component', () => {
  ...
  test('renders filters and automation content', () => {
    ...
    const automationContentElement = screen.getByRole('region', { name: /Automation Content/i });
  ...
  test('renders automation cards with correct data', () => {
    ...
    const automationCards = screen.getAllByRole('article', { name: /Automation Title/i });
